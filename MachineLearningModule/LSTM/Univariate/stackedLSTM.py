...
class StackedLSTM(UnivariateLSTM):
    ...
    def build_model(self, n_steps):
        ...
        self.model.add(LSTM(3, activation=self.activation_function, return_sequences=True,
                            kernel_regularizer=l2(0.01)))
        self.model.add(Dropout(0.1))
        self.model.add(LSTM(3, activation=self.activation_function, kernel_regularizer=l2(0.01)))
        self.model.add(Dropout(0.1))
