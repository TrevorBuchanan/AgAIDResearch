...
class ImageLoader:
    ...
    def load_image(self, camera_name: str, image_name: str):
        """
        ...
        :return: Image
        """
        image_path = self.get_image_path(camera_name, image_name)
    ...
    @staticmethod
    def get_image_path(camera_name: str, image_name: str) -> str:
        """
